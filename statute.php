                                        ...
                                        <div class="contact_form--wrapper">
                                            <article>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><strong>Serwis</strong> – serwis internetowych Case Study Review, działających pod adresem https://casestudyreview.com</li>
                                                    <li><strong>Usługodawca</strong> – UEK Kraków z adresem siedziby: Ul. Rakowicka 27, 31-510 Kraków, </li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Wymagania techniczne korzystania z Serwisu:<ul>
                                                    ...
                                                    <li>W celu zapewnienia bezpieczeństwa Usługodawcy, Usługobiorcy oraz innych Usługobiorców korzystających z Serwisu, wszyscy Usługobiorcy korzystający z Serwisu powinni stosować się do ogólnie przyjętych zasad bezpieczeństwa w sieci</a>,</li>
                                                    <li>Zabrania się działań wykonywanych osobiście przez Usługobiorców lub przy użyciu oprorgamowania:<ul>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Wymagania techniczne związane z rejestracją konta:<ul>
                                                    ...
                                                    <li>Dodatkowe zasady bezpieczeństwa w zakresie korzystania z konta:<ul>
                                                ...
                                                <ul>
                                                    <li>Serwis udostępnia usługi i narzędzia umożliwiające Usługobiorcom interakcję z Serwisem w postaci:<ul>
                                                            <li>Formularz kontaktowy</li>
                                                            <li>Publikowania własnych treści w postaci wpisów i artykułów</li>
                                                            <li>Publikowanie własnych treści w postaci materiałów graficznych i multimedialnych</li>
                                                        </ul>
                                                    </li>
                                                    <li>Serwis udostępnia dane kontaktowe w postaci:<ul>
                                                            <li>Adresu e-mail</li>
                                                            <li>Telefonu kontaktowego</li>
                                                        </ul>
                                                    </li>
                                                    <li>W przypadku kontaktu Usługobiorcy z Usługodawcą, dane osobowe Usługobiorców będa przetwarzane zgodnie z <a href="privacy-policy.php">Polityką Prywatności</a>, stanowiącą integralną część Regulaminu.</li>
                                                    <li>Warunki umieszczania treści przez Usługobiorców w Serwisie:<ul>
                                                ...
                                                <p>Zakres, cele, sposób oraz zasady przetwarzania danych dostępne są w załącznikach do Regulaminu: <a href="rodo.php">Obowiązek informacyjny RODO</a> oraz w <a href="privacy-policy.php">Polityce prywatności</a>, stanowiących integralną część Regulaminu.</p>
                                                <ul>
                                                    <li><em>Dane zbierane automatycznie:</em><br>Do sprawnego działania Serwisu oraz do statystyk zbieramy automatycznie niektóre dane o Usługobiorcy. Do danych tych należą:<ul>
                                                            <li>Adres IP</li>
                                                            ...
                                                            <li>Anonimowe dane demograficzne na podstawie danych Google Analytics: <ul>
                                                                    <li>Płeć</li>
                                                                    <li>Wiek</li>
                                                    ...
                                                    <li><em>Dane zbierane podczas rejestracji:</em><br>Nazwa użytkownika, imię i nazwisko, adres e-mail<p>W przypadku Usługobiorców zalogowanych (posiadających konto w Serwisie), w plikach cookies zapisywanych na urządzeniu Usługobiorcy może być umieszczony identyfikator Usługobiorcy powiązany z kontem Usługobiorcy</p>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>We wszelkich sprawach związanych z działalnością Serwisu należy kontaktować się z Usługodawcę korzystając z jednej z poniższych form kontaktu:<ul>
                                                            <li>Używając formularza kontaktowego dostępnego w Serwisie</li>
                                                            <li>Wysyłając wiadomość na adres e-mail: support@casestudyreview.com</li>
                                                            <li>Poprzez połączenie telefoniczne z numerem: +48 22 123 45</li>
                                                        </ul>Kontakt przy użyciu wskazanych środków komunikacji wyłącznie w sprawach związanych z prowadzonym Serwisem.</li>
                                                </ul>
                                            </article>
                                        </div>
                                    </div>
