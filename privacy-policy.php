                                ...
                                <div class="col-md-8 offset-md-2">
                                    <div class="contact_form--wrapper">
                                        <article>
                                            ...
                                            <p>Poniższa Polityka Prywatności jest integralną częścią <a href="statute.php">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
                                            <h2 style="text-align:center">§1 Definicje</h2>
                                            <ul>
                                                <li>
                                                    <p><strong>Serwis</strong> - serwis internetowy CaseStudyReview działający pod adresem https://casestudyreview.com</p>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma "UEK Kraków", prowadząca działalność pod adresem: Ul. Rakowicka 27, 31-510 Kraków, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
                                                </li>
                                                <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <p>Informacje o sposobie wyłączenia plików Cookie w najpopularniejszych przeglądarkach komputerowych dostępne są na stronie u jednego ze wskazanych dostawców:<ul>
                                            ...
                                            <ul>
                                                <li>
                                                    <p><strong>Adres pocztowy</strong> - UEK Kraków, Ul. Rakowicka 27, 31-510 Kraków</p>
                                                </li>
                                                <li>
                                                    <p><strong>Adres poczty elektronicznej</strong> - support@casestudyreview.com</p>
                                                </li>
                                                <li>
                                                    <p><strong>Połączenie telefoniczne</strong> - +48 22 123 45</p>
                                                </li>
                                                <li>
